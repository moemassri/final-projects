...
//    }
    ...
    public AuthResponse<UserModel> signUpUser(UserModel appUser) {
...
//        TODO: SEND EMAIL
        ...
        return new AuthResponse<>(userModel, jwtHelper.createUserToken(userModel));
    }

    public AuthResponse<UserModel> userLogin(String email, String password) {
        try{
    ...
    public UserModel getUserById(String userId) {
        ...
        if(user.isEmpty()) {
            throw new CustomException("No user account found with this id", HttpStatus.NOT_FOUND);
        }
